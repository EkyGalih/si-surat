...
var validator = (function($){
    ...
    */
    message = {
        ...
        url             : 'invalid URL',
        number          : 'bukan format nmber',
        email           : 'email address tidak benar',
        email_repeat    : 'emails tidak sama',
        password_repeat : 'password tidak sama',
        repeat          : 'no match',
        complete        : 'input tidak selesai',
        select          : 'silahkan pilih salah satu option'
    };
