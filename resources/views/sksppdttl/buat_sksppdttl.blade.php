...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="{{ url('sksppdttl') }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					{{ csrf_field() }}
					<div class="item form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Perihal Surat Pemohon<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select name="perihal" class="select2_single form-control" tabindex="-1" id="sksppdttl">
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-3">
							...
							<button id="send" type="submit" class="btn btn-info"><i class="fa fa-send"></i> Send</button>
						</div>
					</div>
				</form>
...
<script>
	...
	$(document).ready(function () {
		$( "#sksppdttl" ).change(function() {
			var b = $("#sksppdttl").find(":selected").val();
