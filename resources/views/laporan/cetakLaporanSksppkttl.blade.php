@extends('layout')
@section('judul')
Cetak Surat Keluar SPPK Tatalaksana
@endsection
@section('konten')
<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<div class="x_panel">
			<div class="x_title">
				<h2><i class="fa fa-print"></i> Cetak Laporan Surat Keluar SPPK Tata Laksana<small></i> BWS NT I</small></h2>
			...
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<label class="fa fa-warning"></label> {{ Session::pull('fail') }}, Silahkan lihat data lengkap Skppkttl <a href="{{ url('sksppkttl') }}"><strong>disini</strong></a>
			</div>
			@endif
			<form action="{{ url('reportSksppkttl') }}" method="post">
				{{ csrf_field() }}
