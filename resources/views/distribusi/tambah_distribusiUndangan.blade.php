...
<div class="page-title">
	<div class="title_left">
		<h3>Form Distribusi Undangan</h3>
	</div>
</div>
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Form Distribusi<small> Undangan</small></h2>
			...
			<div class="x_content">
				<br>
				<form id="demo-form2" data-parsley-validate="" method="POST" action="{{ url('procUndangan') }}" class="form-horizontal form-label-left" novalidate="">
					{{ csrf_field() }}
					<div class="col-md-6 col-sm-6 col-xs-6 pull-left">
						<div class="item form-group">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select name="smund_id" class="select2_single form-control" tabindex="-1" id="distribusi">
									<option>Pilih..</option>
									@foreach($undangan as $u)
									<option value="{{ $u->id }}">{{ $u->asal_surat }}</option>
									@endforeach
								</select>
							</div>
						</div>
	...
	<script>
		...
		$(document).ready(function () {
			$( "#distribusi" ).change(function() {
				...
				$.ajax({url: "/suratUndangan/"+b, success: function(result){
