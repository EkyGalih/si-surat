				...
				<table id="datatable-responsive" class="table table-hover table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable" style="width: 1031px;">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								<a href="{{ $f->file }}" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#ModalProg{{$no}}" title="Download File Surat">
									<i class="fa fa-download"></i>
								</a>
							</td>
						...
						<div class="modal fade" id="ModalProg{{$no}}" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">From : <u>{{ $f->staff_bagian }}</u></h4>
									</div>
									<div class="modal-body">
										<center>
											<img height="100%" width="100%" src="{{ url('upload/file_surat/1.jpg') }}">
										</center>
									</div>
