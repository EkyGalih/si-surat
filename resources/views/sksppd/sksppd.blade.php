...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
			<div class="x_title">
				<h2><i class="fa fa-envelope"></i> Daftar Surat SPPD<small></i> BWS NT I</small></h2>
			...
			<div class="table-responsive">
				<a href="{{ url('/sksppd/create') }}" class="btn btn-default submit"><i class="fa fa-plus"></i> Tambah Data</a>
				<table id="datatable-responsive" class="table table-striped table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1031px;">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $s->no_surat }}</td>
							<td align="center">{{ $s->staff_bagian }}</td>
							<td align="center">{{ $s->tgl_surat }}</td>
							<td align="center">{{ $s->kd_klasifikasi }}</td>
							<td>{{ $s->belongsToFilesk->perihal }}</td>
							<td align="center">
								<a href="#" data-toggle="modal" data-target="#ModalSkppd{{$no}}">Baca Surat</a>
							</td>
							<td align="center">
							...
							<td align="center">
								<a href="{{ url('sksppd/'.$s->id.'/edit') }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Ubah data surat">
						...
						<div class="modal fade" id="ModalSkppd{{$no}}" tabindex="-1" role="dialog" aria-hidden="true">
						...
						<div class="modal fade" id="KonfHapus{{$no}}" role="dialog" style="display: none;">
							<div class="modal-dialog" style="margin-top: 260.5px;">
								<div class="modal-content">
									...
									<div class="modal-body">
										<center>
											<form action="{{ url('sksppd/'.$s->id) }}" method="post">
												{{ csrf_field() }}
