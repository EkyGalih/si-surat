...
<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<div class="x_panel">
			<div class="x_title">
				<h2><i class="fa fa-print"></i> Cetak Laporan Surat Masuk Undangan<small></i> BWS NT I</small></h2>
			...
			<div class="alert alert-danger" id="Pesan">
				...
				<label class="fa fa-warning"></label> {{ Session::pull('fail') }}, Silahkan lihat data lengkap surat undangan <a href="{{ url('suratUndangan') }}"><strong>disini</strong></a>
			</div>
			@endif
			<form action="{{ url('reportUndangan') }}" method="post">
				{{ csrf_field() }}
