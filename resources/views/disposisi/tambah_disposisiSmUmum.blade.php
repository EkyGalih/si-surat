@extends('layout')
@section('judul')
Form Disposisi Surat Masuk Umum
@endsection
@section('konten')
<div class="page-title">
	<div class="title_left">
		<h3>Disposisi Surat Masuk Umum</h3>
	</div>
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Form<small> Disposisi Surat Masuk Umum</small></h2>
				...
				<form method="post" action="{{ url('suratmasuk') }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					...
					<div class="col-sm-6 col-md-6 col-xs-6 pull-left">
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="tgl_terima" class="form-control col-md-7 col-xs-12" name="tgl_terima" required="required" type="text">
							</div>
						</div>
						<div class="item form-group">
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="tgl_surat" name="tgl_surat" required="required" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<select name="kd_klasifikasi" required="required" class="select2_single form-control" col-xs-12>
									<option>Pilih..</option>
					...
					<div class="col-sm-6 col-md-6 col-xs-6 pull-right">
						...
						<div class="item form-group">
							...
							<input type="hidden" name="status_smumum" value="proggress">
						</div>
