...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Upload Nomor Surat Keluar<small> BWS NT I</small></h2>
				...
				<form method="post" action="{{ url('filesk/'.$file->id) }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="file" id="file" name="file" value="{{ $file->file }}" required="required" class="form-control col-md-7 col-xs-12">
						</div>
