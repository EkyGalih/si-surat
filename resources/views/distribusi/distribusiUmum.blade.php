...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2><i class="fa fa-share-alt"></i> Daftar Distribusi Surat<small></i> Umum</small></h2>
			...
			<div class="table-responsive">
				<table id="datatable-responsive" class="table table-striped table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-responsive" style="width: 1031px;">
					@if(Auth::user()->divisi == 'Agendaris')
					<a href="{{ url('/distribusi/create') }}" class="btn btn-default submit"><i class="fa fa-plus"></i> Tambah Data</a>
					@endif
					<thead>
						<tr role="row">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$u->belongsToUmum->asal_surat}}</td>
							<td>{{$u->belongsToUmum->perihal}}</td>
							@if(Auth::user()->divisi == 'Agendaris')
							<td align="center">
								<a href="{{ url('distribusi/'.$u->id.'/edit') }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Ubah penerima surat">
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">From : <u>{{$u->belongsToUmum->asal_surat}}</u></h4>
									</div>
									<div class="modal-body">
										<center>
											<img src="{{ $u->belongsToUmum->gambar }}" width="100%" height="100%">
										</center>
									</div>
