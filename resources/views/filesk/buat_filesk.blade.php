...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="{{ url('filesk') }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					{{ csrf_field() }}
					<div class="item form-group">
					</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="hidden" id="staff_bagian" value="{{ Auth::user()->divisi }}" name="staff_bagian" required="required" class="form-control col-md-7 col-xs-12" readonly>
					</div>
				</div>
				<div class="item form-group">
