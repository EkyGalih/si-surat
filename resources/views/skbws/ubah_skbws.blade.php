...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Ubah surat keluar<small> BWS NT I</small></h2>
			...
			<div class="x_content">
				<form method="post" action="{{ url('skbws/'.$surat->id) }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					{{ csrf_field() }}
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select name="perihal" class="select2_single form-control" id="sksbws" disabled>
								@foreach ($file as $f)
								<option value="{{ $f->id }}" @if($f->file == $f->file) selected @endif>{{ $f->perihal }}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select id="statessm" name="kd_klasifikasi" required="required" class="select2_single form-control col-md-7" col-xs-12>
								<option>Pilih..</option>
