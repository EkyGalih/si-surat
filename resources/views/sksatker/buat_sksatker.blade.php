...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="{{ url('sksatker') }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					{{ csrf_field() }}
					<div class="item form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Perihal Surat Pemohon<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select name="perihal" class="select2_single form-control" tabindex="-1" id="sksatker">
...
<script>
	...
	$(document).ready(function () {
		$( "#sksatker" ).change(function() {
			var b = $("#sksatker").find(":selected").val();
