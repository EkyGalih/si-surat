...
<head>
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css2/animate.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css2/font-family.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css2/templatemo-style.css') }}">
    ...
    <script type="text/javascript" src="{{ asset('assets/js2/jquery.singlePageNav.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('assets/js2/wow.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('assets/js2/custom.js')}}"></script>
</head>
<body id="top">
