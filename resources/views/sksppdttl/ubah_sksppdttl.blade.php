...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2><i class="fa fa-envelope"></i> Daftar Surat PPDTTL<small></i> BWS NT I</small></h2>
			...
			<div class="x_content">
				<form method="post" action="{{ url('sksppdttl/'.$surat->id) }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
					{{ csrf_field() }}
